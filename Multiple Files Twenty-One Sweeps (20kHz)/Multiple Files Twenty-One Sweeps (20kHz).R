...
### This code has been modified by Turner Lime and Regina Mangieri, PhD
### to accommodate Current Clamp Voltage Traces for protocols with 21 Sweeps
### and a sampling rate of 20 kHZ (as compared to 10kHz - the original sampling frequency)
###
### Alterations include: 
